...
namespace InterUserService.Test.Mocks.Logic
{
    public class MockHttpClient : Mock<IHttpHandler>
    {
        Dictionary<string, string> getResponses = new Dictionary<string, string> {
            { "http://localhost:5002/api/profile/GetCurrentProfile",
              "{\"result\":{\"id\":\"5e209dbe44dcb183fcecddcf\",\"name\":\"My FirstName My LastName\",\"profileType\":0},\"isSuccessful\":true,\"message\":\"Successful\"}" },
            ...
            { "http://localhost:5002/api/profile/GetProfiles::[{\"id\":\"5e20ad1651c7c1df345d41a1\",\"name\":null,\"profileType\":\"Professional\"},{\"id\":\"5e209dbe44dcb183fcecddcf\",\"name\":null,\"profileType\":\"GeneralUser\"}]", "{\"result\":[{\"id\":\"5e209dbe44dcb183fcecddcf\",\"name\":\"My FirstName My LastName\",\"profileType\":\"GeneralUser\"},{\"id\":\"5e20ad1651c7c1df345d41a1\",\"name\":\"name\",\"profileType\":\"Professional\"}],\"isSuccessful\":true,\"message\":\"Successful\"}" }
