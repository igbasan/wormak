...
{
    public class ProfessionalLogicTest : ProfileLogicTest<Professional>
    {
        [Fact]
        ...
        [Theory]
        [InlineData("KnownUserID", "knownName")] //When user already has a service with the name
        [InlineData("KnownUserID", "Name")] //When user does not have a service with the name
        ...
        public async void UpdateProfileAsync_NotNull_UniqueProfileTest(string userID, string name, string nameMatchId)
        {
